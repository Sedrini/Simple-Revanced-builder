...
from downloader import scrape_url,main_download,check_update
...
def main_gui():
    ...
    layout = [  
        [sg.Text('Simple Revanced-builder 1.0',justification='right', font=('Helvetica', 13),pad=((0, 0), (10, 0))),
        ...
        [sg.Input(key='-FILE-', visible=False, enable_events=True), sg.FileBrowse(button_text="Patch",pad=((15, 0), (30, 0))),
    ...
    while True:
        ...
        if event == '-FILE-':
            if values['-dropdown-'] == "":
                ...
                patcher_def(values['-FILE-'],values['-dropdown-'] )            
